class Constants {
  ...
  static const int ipadLimit = 1024;
  ...
  // Social Media Links
  static const String SHAHI_FACEBOOK = "https://www.facebook.com/officialshahifoods";
  static const String SHAHI_YOUTUBE = "https://www.youtube.com/channel/UCWqGERXhLKa6XGxm1S5UlhA";
  static const String SHAHI_INSTAGRAM = "https://www.instagram.com/officialshahifoods";

  static const String SUPPORT_EMAIL = '';
...
// CSR Texts
  static const String HEALTH_CARE_TEXT = "Shahi has an in house medical facility, available to all our employees, their dependents as well as the general public for consultation/ advice and emergency. The in-house clinic facilitates employees that require OPD treatment, diagnostic assistance and general medicine free of cost.\n\n"
      "This medical facility is in collaboration with SINA Health, Education & Welfare Trust. SINA’s greatest asset is its quality management system. All doctors at SINA clinics are trained to use this protocol-based system and are evaluated by the medical team at the SINA-Head Office based on their performance every month SINA’s top management is led by trained doctors and professionals associated with The Agha Khan University Hospital and other reputed organizations.";

  static const String EDUCATION_TEXT = "Shahi believes that along with health and well-being, the most important social need in Pakistan is the proper education of its growing youth. At Shahi, we believe that investment in the education of our future generations is the key to creating a sustainable developing society and country.\n\n"
      "Shahi believes that along with health and well-being, the most important social need in Pakistan is the proper education of its growing youth. At Shahi, we believe that investment in the education of our future generations is the key to creating a sustainable developing society and country.";
